...
void MemoriaOptionsUsage(char *pgm_name)
{
  ...
  puts("         -t  dump the abstract syntax tree");
...
static void mc_opt_ast_dump(void *state)
{
  if (selection != NO_SELECT)
    MemoriaOptionsUsage("Memoria");
  selection = AST_DUMP;
...
{
  Option *mc_mod_opt = InitOption(stringt, MC_MOD_OPT, (Generic) "", true,
                                  (Generic)&module_s),
         *mc_pgm_opt = InitOption(stringt, MC_PGM_OPT, (Generic) "", true,
                                  (Generic)&program_s),
         *mc_lst_opt = InitOption(stringt, MC_LST_OPT, (Generic) "", true,
                                  (Generic)&module_list_s),
         *mc_cfg_opt = InitOption(stringt, MC_CFG_OPT, (Generic) "", true,
                                  (Generic)&config_s),
         *mc_out_opt = InitOption(stringt, MC_OUT_OPT, (Generic) "", true,
                                  (Generic)&output_s),
         *mc_partition_unroll_opt = InitOption(stringt, MC_PARTITION_UNROLL_OPT,
                                               (Generic) "",
                                               true,
