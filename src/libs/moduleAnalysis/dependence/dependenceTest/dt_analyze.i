/* $Id: dt_analyze.i,v 1.4 1997/03/11 14:35:52 carr Exp $ */
/******************************************************************************/
...
/*-----------------------------------------------------------------------
	...
	dt_analyze.i		Private Dependence Test Module Header File
...
EXTERN(int, gcd2, (int num, int *ptr));
EXTERN(void, dt_consistent_str, (DG_Edge *Edge, char *cbuf));
