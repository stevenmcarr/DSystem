/* $Id: CommFilterDef.C,v 1.2 1997/03/11 14:30:12 carr Exp $ */
/******************************************************************************/
...
/************************************************************************/
/*									*/
/*	ded_cp/comm/CommFilterDef.C					*/
/*									*/
/*	CommFilterDef -- View filter defs for Ded comm pane		*/
...
/* CommFilterDef object */

typedef struct CommFilterDef_Repr_struct
  {
    /* not used */
...
#define R(ob)		(ob->CommFilterDef_repr)
...
void CommFilterDef::InitClass(void)
{
  /* initialize needed submodules */
    REQUIRE_INIT(UserFilterDef);
    REQUIRE_INIT(FilterDefSet);
...
void CommFilterDef::FiniClass(void)
{
  /* nothing */
}
...
META_IMP(CommFilterDef)




CommFilterDef::CommFilterDef(Context context,
                                 DB_FP * session_fd,
                                 CommEditor * editor)
             : UserFilterDef(context, session_fd)
{
  /* allocate instance's private data */
    this->CommFilterDef_repr =
        (CommFilterDef_Repr *) get_mem(sizeof(CommFilterDef_Repr), "CommFilterDef instance");
}




CommFilterDef::~CommFilterDef()
{
  free_mem((void*) this->CommFilterDef_repr);
}




void CommFilterDef_AddStandardDefs(FilterDefSet * defs)
{
...
Boolean CommFilterDef::function(char * name, int &numArgs, int &opcode)
{
...
Boolean CommFilterDef::execute(int opcode, int linenum, char * line,
...
UserFilter * CommFilterDef::MakeFilter(void * environment)
{
  UserFilter * uf;
...
{
  CommEditor * editor = (CommEditor *) defs->GetEditor();
  CommFilterDef * def;
  char * dummy;

  def = new CommFilterDef(CONTEXT_NULL, DB_NULLFP, editor);
