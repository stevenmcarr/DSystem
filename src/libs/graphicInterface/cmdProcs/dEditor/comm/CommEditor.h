/* $Id: CommEditor.h,v 1.2 1997/03/11 14:30:12 carr Exp $ */
/******************************************************************************/
...
class CommEditor: public ColumnEditor
{
public:

  CommEditor_Repr_struct * CommEditor_repr;
...
/* initialization */
  META_DEF(CommEditor)
				CommEditor(Context context,
                                           DB_FP * session_fd,
                                           DedEditor * owner);
  virtual			~CommEditor(void);
