/* $Id: SD_Map.ft_export-OLD.C,v 1.2 1997/03/11 14:29:03 carr Exp $ */
/******************************************************************************/
/*        Copyright (c) 1990, 1991, 1992, 1993, 1994 Rice University          */
/*                           All Rights Reserved                              */
/******************************************************************************/
// -*- C++ -*-
static const char * RCS_ID = "$Id: SD_Map.ft_export-OLD.C,v 1.2 1997/03/11 14:29:03 carr Exp $";
#define MKASSERT
...
#include <libs/graphicInterface/oldMonitor/OBSOLETE/db/object.h>
...
int  SDDF_SideArray::WriteNormalizedFile(char* moduleFileName)
{
  ...
  Context context = NULL;		// ft_export(...)
  FortTree ft = myFt;
  FortTextTree ftt = myFtt;
  Company dialect = None;
  
  //-------- COPIED FROM FUNCTION ft_export() IN ft_export.C -------------
