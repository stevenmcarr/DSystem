/* $Id: SD_Globals.C,v 1.1 1997/03/11 14:29:01 carr Exp $ */
/******************************************************************************/
...
/* $Header: /home/cs/carr/cvsroot/DSystem/src/libs/fortD/performance/staticInfo/SD_Globals.C,v 1.1 1997/03/11 14:29:01 carr Exp $
*/

static const char * RCS_ID = "$Id: SD_Globals.C,v 1.1 1997/03/11 14:29:01 carr Exp $";
...
void SetStringInDossier(RecordDossier & d, const char * entryName, 
  ...
  ProcName->setCellString(theString);
}
