/* $Id: la-lattice.C,v 1.1 1997/04/28 20:20:00 carr Exp $ */
/******************************************************************************/
...
LA_LATTICE_T la_lattice(LA_LOOPNEST_T nest)
  // LA_LOOPNEST_T nest;
{
...
LA_LATTICE_T la_lattice_new(int depth,int  blobs)
  // int depth;
  // int blobs;
{
...
void la_lattice_print(LA_LATTICE_T lattice)
  // LA_LATTICE_T lattice;
{
