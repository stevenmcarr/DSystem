/* $Id: la-code.c,v 1.2 1997/03/27 20:47:40 carr Exp $ */
/******************************************************************************/
...
LA_EXPR_T la_expr_new(dim, blobs )
     int dim;
     int blobs;
{
...
LA_LOOPNEST_T la_nest_new(depth, blobs)
     int depth;
     int blobs;
{
...
LA_VECTOR_T la_vector_new( size )
     int size;
{
