/* $Id: la-dep1.c,v 1.2 1997/03/27 20:47:40 carr Exp $ */
/******************************************************************************/
...
LA_DEP_V_T la_dep_vec_new( size )
     int size;
{
  LA_DEP_V_T d;
...
LA_DEP_M_T la_dep_matrix_new(dim, size)
     int dim;
     int size;
{
...
LA_DEP_M_T la_dep_no_redundant(D)
     LA_DEP_M_T D;
{
