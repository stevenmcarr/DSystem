/* $Id: la-matrix.c,v 1.2 1997/03/27 20:47:40 carr Exp $ */
/******************************************************************************/
...
void la_matNegate(mat1, mat2, m, n)
     la_matrix mat1;
     la_matrix mat2;
     int m;
     int n;
...
void la_matAdd(mat1, mat2, mat3, m, n)
     la_matrix mat1;
     la_matrix mat2;
     la_matrix mat3;
     int m;
...
void la_matAddF(mat1, f1, mat2, f2, mat3, m, n)
     la_matrix mat1;
     int f1;
     la_matrix mat2;
     int f2;
...
void la_matMult(mat1, mat2, mat3, m, r, n)
     la_matrix mat1;
     la_matrix mat2;
     la_matrix mat3;
     int m;
...
void la_matGetCol(mat, m, col, vec)
     la_matrix mat;
     int m;
     int col;
     la_vect vec;
...
void la_matConcat(mat1, m1, mat2, m2, mat3)
     la_matrix mat1;
     int m1;
     la_matrix mat2;
     int m2;
...
void la_matConcat_newM(mat1, m1, col, mat2, m2, mat3)
     la_matrix mat1;
     int m1;
     int col;
     la_matrix mat2;
...
void la_rowAdd (mat, n, i1, i2, fact)
     la_matrix mat;
     int n;
     int i1;
     int i2;
...
void la_eDeleteRows(matrix, m, r1, r2)
     la_matrix matrix;
     int m;
     int r1;
     int r2;
...
void  la_projToNull(B, rowSize, colSize, k, x)
     la_matrix B;
     int rowSize;
     int colSize;
     int k;
