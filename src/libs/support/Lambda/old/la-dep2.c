/* $Id: la-dep2.c,v 1.2 1997/03/27 20:47:40 carr Exp $ */
/******************************************************************************/
...
LA_DEP_T la_vec_depV_mult(vec1, d, dim)
     la_vect vec1;
     LA_DEP_V_T d;
     int dim;
{
...
LA_DIR_T la_vec_depVec_mult(vec1, d, dim)
     la_vect vec1;
     LA_DEP_V_T d;
     int dim;
{
...
int la_allNegEq(flagV, flagSize)
     LA_DIR_T *flagV;
     int flagSize;
{
...
int la_allPosEq(flagV, flagSize)
     LA_DIR_T *flagV;
     int flagSize;
{
  int allPos = TRUE;
...
void  la_flagNegate(flagV, flagSize)
     LA_DIR_T *flagV;
     int flagSize;
{
  int i;
...
void la_dep_add_to_list_last(d, D, last)
     LA_DEP_V_T d;
     LA_DEP_M_T D;
     LA_DEP_V_T last;
{
...
int la_redundantDepElim(depM, depSize, nestLevel, newM)
     la_matrix depM, newM;
